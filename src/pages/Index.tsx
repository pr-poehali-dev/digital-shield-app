...
const PLANS = [
  ...
  {
    name: "Премиум", price: "149 ₽", period: "в месяц", desc: "", featured: true,
    features: ["Игры базового уровня кибербезопасности", "Создание собственных мошеннических игр"],
    cta: "Оформить подписку",
  },
  {
    name: "Максимум", price: "5 490 ₽", period: "в месяц", desc: "Для организаций", featured: false,
