...
const PLANS = [
  {
    name: "Стандарт", price: "0 ₽", period: "бесплатно", desc: "", featured: false,
    features: ["Игры базового уровня кибербезопасности"],
    cta: "Начать бесплатно",
  },
  {
    name: "Премиум", price: "149 ₽", period: "в месяц", desc: "", featured: false,
    features: ["Игры базового уровня кибербезопасности", "Создание собственных мошеннических игр", "Личный куратор 24/7", "Решение продвинутых мошеннических игр"],
    cta: "Оформить подписку",
  },
  {
    name: "Максимум", price: "5 490 ₽", period: "в месяц", desc: "Для организаций", featured: true,
    features: ["Игры базового уровня кибербезопасности", "Создание собственных мошеннических игр", "Неограниченное количество пользователей", "Личный куратор 24/7", "Решение продвинутых мошеннических игр"],
    cta: "Оформить подписку",
  },
];
